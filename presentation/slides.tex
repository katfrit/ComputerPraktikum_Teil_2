...
% ----------------------------------------------------------------------------------------
    ...
    \textbf{Stack initialisieren:} Solange Stack nicht leer - nächste Node heraus holen
        \begin{itemize}
            \item Wenn Datenmenge klein genug ist: Leaf-Node erstellen

            \item Daten splitten und beide Kinder zum Stack hinzufügen\\
